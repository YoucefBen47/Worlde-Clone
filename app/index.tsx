  ...
  return (
    <View style={[styles.container, { backgroundColor }]}>
      ...
      <View style={styles.footer}>
        <ThemedText style={styles.text}>Made by Simon</ThemedText>
      </View>
      <View style={styles.footer}>
        <ThemedText style={styles.footerDate}>
          {format(new Date(), "MMMM d, yyyy")}
        </ThemedText>
        <ThemedText style={styles.footerText}>No. 1143</ThemedText>
        <ThemedText style={styles.footerText}>Edited by Youced Dev</ThemedText>
      </View>
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 40, fontFamily: "FrankRuhlLibre_800ExtraBold" },
  text: {
    fontSize: 26,
    textAlign: "center",
